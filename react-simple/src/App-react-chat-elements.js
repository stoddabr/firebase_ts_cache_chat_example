...
export class App extends Component {
    ...
    addMessage() {
        ...
        list.push(this.generate_random_message('message'));
        this.setState({
            messageList: list,
        });
        console.log('message list:',this.state.mess)
    }
    ...
    render() {
        ...
        var chatSource = arr.map(x => this.generate_random_message('chat'));
